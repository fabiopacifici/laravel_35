...
<div class="container">
  ...
  <form action="{{ route('movies.update', $movie->id) }}" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" name="title" id="title" class="form-control" placeholder="Add a title" aria-describedby="titleHelper" value="{{$movie->title}}">
    ...
    <div class="form-group">
      ...
      <input type="url" name="poster" id="poster" class="form-control" placeholder="type an url" aria-describedby="coverHelper" value="{{$movie->poster}}">
